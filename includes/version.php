...
$versions = [
    ['ver' => '2.26.0', 'date' => '2026-09-11', 'changes' => ['IP Conflict Detection Engine with MAC Flapping Protection', 'Conflict Diagnostic Prober Tool (TTL variance & ARP integrity)', 'Subnet Allocation Conflict Badges and Resolution Modal', 'Dynamic Multi-Drive MIBDIRS Auto-Detection', 'PHP Function Redeclaration Guards & Autoloading Stabilization']],
